 ...
 */
public class TestUserDataInformation {
    ...
    private String learnCategoryName = Category.learn;
    public String rightSuperCategory;
    public String rightChildrenCategory;
    ...
    public TestUserDataInformation(String userDataInformation) throws IOException, ParseException {
    ...
    private void initUserInformation(String[] splits) throws ParseException {
        reqURL = splits[0];
        rightChildrenCategory = splits[2];
        rightSuperCategory = splits[1];
//        isRightTime = true;
...
//                    System.out.println("f" + normalCategory);
                    categoryJsonObject = categoryJsonObject.getJSONObject(normalCategory);
                } else if (i < Constants.LAYER && normalCategory.equals(Constants.NOISE)) {
//                    System.out.println("l" + learnCategoryName);
    ...
    private double similarScore(String word, String type) throws IOException, InterruptedException {
        double score;
        URL url = new URL(String.format(Constants.WORDS_DISTANCE_URL, word, type));
    ...
    public String toString() {
        if (normalCategory.equals(Constants.NOISE) && sensitiveId.size() >= Constants.SENSITIVE_WORD_NUM) {
            ...
            return uid + Constants.SEPARATOR + reqTime + Constants.SEPARATOR + reqURL;
    ...
    public static void main(String[] args) throws IOException, JSONException, InterruptedException, ParseException {
        ...
        String s = "http://www.tuicool.com/articles/ZnyMvu\t20160405114421\t192.168.1.104\t55368\t123.125.115.99\t中医\tGET\tJava/1.7.0_79";
        TestUserDataInformation userDataInformation = new TestUserDataInformation(s);
...
//            sum++;
//            TestUserDataInformation userDataInformation = null;
//            try {
//                userDataInformation = new TestUserDataInformation(s);
//                bufferedWriter.write(userDataInformation.getURL() + userDataInformation.rightSuperCategory+"  "+userDataInformation.rightChildrenCategory+"  ");
////                bufferedWriter.write("\n");
//                userDataInformation.commonClassify();
//                userDataInformation.sensitiveClassify();
//                bufferedWriter.write(userDataInformation.getURLCategory());
//                if((!userDataInformation.getURLCategory().equals("noise"))&&userDataInformation.getURLCategory().equals(userDataInformation.rightChildrenCategory)){
//                    rightChildren++;
//                }
//                if((!userDataInformation.getURLCategory().equals("noise"))&&Category.categorySuperId.get(userDataInformation.rightChildrenCategory).equals(Category.categorySuperId.get(userDataInformation.getURLCategory()))){
//                    rightSuper++;
//                }
//                bufferedWriter.write("\n");
...
//        }
//        System.out.println(sum+"  "+rightChildren+"  "+rightSuper);
